                ...
                <form action="{{ $url_action }}" method="post" accept-charset="UTF-8" class="form-horizontal" id="form-main"
                    ...
                    <div class="box-body">
                        <div class="fields-group">
                            @php
                                $descriptions = $shopKnowledges?$shopKnowledges->descriptions->keyBy('lang')->toArray():[];
                            @endphp
                            ...
                            <div class="form-group   {{ $errors->has('alias') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                                        <input type="text" id="alias" name="alias" value="{!! old('alias',($shopKnowledges['alias']??'')) !!}"
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <input type="text" id="image" name="image"
                                               value="{{ old('image',$shopKnowledges['image']??'') }}"
                                    ...
                                    <div id="preview_image" class="img_holder">
                                        @if (old('image',$shopKnowledges['image']??''))
                                            <img src="{{ asset(old('image',$shopKnowledges['image']??'')) }}">
                                        @endif
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <input type="number" style="width: 100px;" id="sort" name="sort"
                                               value="{{ old()?old('sort'):$shopKnowledges['sort']??0 }}" class="form-control sort"
                                               placeholder="" />
                                    </div>
                                    @if ($errors->has('sort'))
                                        <span class="help-block">
                            ...
                            <div class="form-group  ">
                                ...
                                <div class="col-sm-8">
                                    <input type="checkbox" name="status"
                                            {{ old('status',(empty($shopKnowledges['status'])?0:1))?'checked':''}}>
