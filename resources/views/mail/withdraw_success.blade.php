    ...
    <tr style="background:#fff">
        <td align="left" height="auto" style="padding:15px" width="600">
            <table >
                ...
                <tr>
                    <td>
                        <h1 style="font-size:17px;font-weight:bold;color:#444;padding:0 0 5px 0;margin:0">Xin chào {{$user->first_name . ' ' .$user->last_name}}, yêu cầu rút tiền của quý khách đã được xác nhận.</h1>

                        <p style="margin:4px 0;font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#444;line-height:18px;font-weight:normal">
                            Chúng tôi rất vui thông báo yêu cầu rút tiền #{{$withdraw->id}} của quý khách đã được xác nhận. Tiền của quý khách sẽ được chuyển về tài khoản ngân hàng từ 24h - 48h kể từ sau khi yêu cầu được xác nhận</p>
                    </td>
                </tr>
                <tr>
                    <td>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" style="background:#f5f5f5" width="100%">
                            ...
                            <tr bgcolor="#eee">
                                <td align="right" colspan="3" style="padding:7px 9px"><strong><big>Tổng giá trị</big> </strong></td>
