...
<div class="container">
    ...
    <div class="box collapsed-box">
        <div class="box-body">
            <form action="{{ route('affiliate.withdraw_info.update') }}" method="post" accept-charset="UTF-8" class="form-horizontal" id="form-main">
                <div class="box-body">
                            ...
                            <div class="{{ $errors->has('bank') ? ' has-error' : '' }}">
                                ...
                                <select name="bank" id="bank" class="select2" required>
                                    @foreach(get_vn_banks() as $bank)
                                        <option value="{{$bank}}" {{($bank == $bank_info->bank ? 'selected' : '')}}>{{$bank}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="fields-group col-sm-12">
                        <div class="col-sm-6 col-md-push-3">
                            <div class="{{ $errors->has('branch') ? ' has-error' : '' }}">
                                ...
                                <input type="text" id="branch" name="branch" value="{{$bank_info->branch}}"
                    ...
                    <div class="fields-group col-sm-12">
                        <div class="col-sm-6 col-md-push-3">
                            <div class="{{ $errors->has('card_name') ? ' has-error' : '' }}">
                                ...
                                <input type="text" id="card_name" name="card_name" value="{{$bank_info->card_name}}"
                    ...
                    <div class="fields-group col-sm-12">
                        <div class="col-sm-6 col-md-push-3">
                            <div class="{{ $errors->has('card_number') ? ' has-error' : '' }}">
                                ...
                                <input type="text" id="card_number" name="card_number" value="{{$bank_info->card_number}}"
